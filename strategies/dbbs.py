"""
strategies/dbbs.py — DBB Squeeze (DBBS): double squeeze breakout.
...
class DbbsStrategy(BaseStrategy):
    """DBB Squeeze — simultaneous BB20/BB50 breakout with H1 trailing exit."""
    ...
    def analyze_setup(
        ...
        return StrategyResult(
            ...
            candidate_score=0.0,
            raw_features=raw,
            strategy_action="ALLOW" if is_dbbs_pure_data_mode() else "ALLOW",
            base_risk_pct=None,
        )
